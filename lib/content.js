...
export const services = [
  ...
  {
    id: "landscape-lighting-repair",
    title: "Repair & Maintenance",
    iconKey: 'repair', // Key for useImage hook
    slug: "/landscape-lighting-repair",
    description: "Troubleshooting, repairs, and system refreshes"
  }
];
...
export const serviceData = {
  ...
  'landscape-lighting-repair': {
    title: 'Landscape Lighting Repair & Maintenance',
    seoTitle: 'Landscape Lighting Repair in Wichita, KS | Lume Outdoor',
    seoDescription: 'Landscape lighting repair and maintenance in Wichita, KS. Lume troubleshoots low-voltage systems, fixtures, wiring, transformers, timers, controls, and lighting that needs adjustment.',
    subtitle: 'Troubleshooting and restoring outdoor lighting systems across the Wichita area',
    description: 'When landscape lights flicker, go dark, fall out of alignment, or stop responding to their controls, the whole property can feel off. Lume diagnoses the system, explains what needs attention, and handles repairs, adjustments, replacements, and upgrades for most professionally installed low-voltage outdoor lighting systems.',
    heroImage: '/projects/crestview_project/showcase_photo.jpeg',
    benefits: [
      'Lights that flicker, dim, or stop working',
      'Damaged wiring and connection troubleshooting',
      'Fixture cleaning, repositioning, and beam adjustments',
      'Transformer, timer, photocell, and control checks',
      'LED, fixture, and component replacement',
      'System additions, upgrades, and full lighting refreshes'
    ],
    process: [
      'Inspect the fixtures, wiring, transformer, and controls',
      'Find the source of the failure or uneven performance',
      'Explain the recommended repair and expected costs',
      'Repair, replace, clean, or reposition system components',
      'Test the complete system and refine fixture aiming',
      'Document any future maintenance or upgrade priorities'
    ],
    ctaLabel: 'Schedule a Repair Visit',
    ctaTitle: 'Get Your Outdoor Lighting Working Again',
    ctaBody: 'Tell us what your system is doing and we’ll schedule a visit to inspect it.',
    attributionContent: 'landscape_lighting_repair_service',
    faqs: [
      {
        question: 'Do you repair landscape lighting installed by another company?',
        answer: 'Yes. We can inspect and repair most professionally installed low-voltage outdoor lighting systems, even when Lume was not the original installer.'
      },
      {
        question: 'What kinds of outdoor lighting problems do you repair?',
        answer: 'We handle lights that are out, dim, flickering, misaligned, damaged, or no longer responding correctly. We can also troubleshoot wiring, connections, transformers, timers, photocells, and controls.'
      },
      {
        question: 'Can you update an older lighting system?',
        answer: 'Yes. Depending on the condition of the system, we can replace worn components, upgrade fixtures or controls, add lights, and rebalance the design as landscaping changes.'
      },
      {
        question: 'Is repair labor covered by the product warranty?',
        answer: 'No. Fixtures and transformers supplied by Lume include a 20-year product warranty, while labor, installation, maintenance visits, and adjustments are not covered.'
      },
      {
        question: 'How do I know what the repair will cost?',
        answer: 'We first inspect the system and identify the cause. We then explain the recommended work and expected cost before completing the repair.'
      }
    ]
  },
  'holiday-lighting': {
