...
export const projectDetails = {
  ...
  'wichita-traditional-home': {
    ...
    results: "The transformation took just one day, with Drake personally overseeing every detail. As the sun set on installation day, the Millers couldn't believe their eyes. Their home now has incredible curb appeal, the driveway feels safe and inviting, and neighbors have been stopping by asking for our card. Mrs. Miller loves how the lights make coming home from her evening book club feel magical.",
    testimonial: {
      quote: "Drake turned our house into a home that glows with warmth. Our teenagers actually comment on how cool it looks, and that's saying something! The whole process was so smooth, and these guys really care about getting every detail right.",
