...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "You guys knocked it out of the park! To say we love the outcome is an understatement. Thank you for helping us see our home in a new light! We love it 😍",
  ...
  const comingSoonSlots = [
    { id: 'coming1', text: 'More reviews coming soon' },
    { id: 'coming2', text: 'Building beautiful spaces' }
  ];
