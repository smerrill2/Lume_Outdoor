...
function ServicePage({ serviceId = 'residential-landscape' }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-16">
        ...
        {/* Process Section */}
        <section ref={el => contentRefs.current[3] = el} className="bg-brand-green text-white py-16">
        ...
        {/* CTA Section */}
        <section ref={el => contentRefs.current[4] = el} className="py-16 text-center">
          <div className="max-w-4xl mx-auto px-4">
